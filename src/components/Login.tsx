...
export default function Login({ onLogin }: LoginProps) {
  ...
  return (
    <div className="min-h-screen bg-[#F8FAFC] text-[#0F172A] flex flex-col lg:grid lg:grid-cols-12 overflow-hidden relative font-sans">
      ...
      <div className="hidden lg:block absolute top-0 bottom-0 left-[51%] -translate-x-1/2 w-48 pointer-events-none z-10 h-full">
      ...
      <div className="lg:col-span-7 flex flex-col justify-between p-8 md:p-16 lg:p-24 z-10 relative">
        {/* Brand Header */}
        <div className="flex items-center gap-3">
          <div className="w-12 h-12 rounded-xl bg-white flex items-center justify-center shadow-md border border-zinc-200">
      ...
      <div className="lg:col-span-5 flex items-center justify-center p-6 md:p-12 lg:p-16 xl:p-24 z-10 relative">
        ...
        <motion.div
          ...
          className="w-full max-w-[540px] bg-white border border-zinc-200/60 rounded-2xl p-10 md:p-12 shadow-[0_25px_60px_-15px_rgba(0,0,0,0.06)]"
        >
          ...
          <form onSubmit={handleSubmit} className="space-y-5">
              ...
              <div className="group">
                ...
                <div className="relative">
                  ...
                  <input
                    ...
                    className="w-full pl-11 pr-4 py-3.5 bg-white border border-zinc-200 rounded-xl text-zinc-800 placeholder-zinc-400 outline-none focus:border-[#098043] focus:ring-1 focus:ring-[#098043] transition-all text-sm shadow-sm"
                  />
                </div>
              </div>
            )}
            ...
            <button
              type="submit"
              className="w-full mt-6 bg-[#098043] hover:bg-[#076635] text-white font-bold py-4 rounded-xl transition-all duration-300 shadow-md active:scale-[0.98] flex items-center justify-center gap-2 cursor-pointer text-sm"
            >
              <LogIn size={16} />
